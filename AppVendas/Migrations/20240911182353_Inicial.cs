    ...
    public partial class Inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemsDaVendas", x => x.ItemDaVendaId);
                    table.ForeignKey(
                        name: "FK_ItemsDaVendas_Produtos_ProdutoId",
                        column: x => x.ProdutoId,
                        principalTable: "Produtos",
                        principalColumn: "ProdutoId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemsDaVendas_Vendas_VendaId",
                        column: x => x.VendaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemsDaVendas_ProdutoId",
                table: "ItemsDaVendas",
                column: "ProdutoId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemsDaVendas_VendaId",
                table: "ItemsDaVendas",
                column: "VendaId");
