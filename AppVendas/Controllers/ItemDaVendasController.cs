...
namespace AppVendas.Controllers
{
    public class ItemDaVendasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ItemDaVendaId,VendaId,ProdutoId,QtdadeVendida,ValorTotalVenda")] ItemDaVenda itemDaVenda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ItemDaVendaId,VendaId,ProdutoId,QtdadeVendida,ValorTotalVenda")] ItemDaVenda itemDaVenda)
        {
